...
CREATE TABLE "rpd"."playlist" ("id" serial NOT NULL, "created_at" timestamptz NOT NULL DEFAULT now(), "updated_at" timestamptz NOT NULL DEFAULT now(), "name" text NOT NULL, "public" boolean NOT NULL DEFAULT true, "created_by" text NOT NULL, PRIMARY KEY ("id") , FOREIGN KEY ("created_by") REFERENCES "keycloak"."user_entity"("id") ON UPDATE restrict ON DELETE restrict);
CREATE OR REPLACE FUNCTION "rpd"."set_current_timestamp_updated_at"()
RETURNS TRIGGER AS $$
DECLARE
  _new record;
